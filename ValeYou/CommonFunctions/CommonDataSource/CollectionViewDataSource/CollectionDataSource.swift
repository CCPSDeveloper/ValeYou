...
class CollectionDataSource: NSObject {
    ...
    init(_items: Array<Any>?, _identifier: String?, _collectionView: UICollectionView,  _size: CGSize?,  _edgeInsets: UIEdgeInsets?,  _lineSpacing: CGFloat?,  _interItemSpacing: CGFloat?,  configureCell: ListCollectionConfig? = nil ,didSelectedItem:DidSelectedItem? = nil ) {
        super.init()
        items = _items
        ...
        self.didSelectItem = didSelectedItem
