...
- (void)viewDidLoad {
    ...
    if (_isRTL){
        [_btnBack setImage: [_btnBack.imageView.image imageWithHorizontallyFlippedOrientation] forState: UIControlStateNormal];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TableViewCellCountryCode *cell = [tableView dequeueReusableCellWithIdentifier:@"TableViewCellCountryCode"];
...
- (void)filterContentForSearchText:(NSString*)searchText scope:(NSString*)scope{
    NSPredicate *resultPredicate    = [NSPredicate predicateWithBlock:^BOOL(id  _Nullable evaluatedObject, NSDictionary<NSString *,id> * _Nullable bindings) {
        ...
        NSString *stringName = [dict valueForKey:@"name"];
