    ...
    protected void subscribeToEvents(final LoginActivityVM vm) {
       ...
       /* boolean isRem = sharedPref.get("isRemeber",false);
        ...
        if (isRem){
            ...
            binding.etEmail.setText(sharedPref.get(Constants.EMAIL,""));
            binding.etPassword.setText(sharedPref.get(Constants.PASSWORD,""));
        }
*/
            ...
            switch (view != null ? view.getId() : 0) {
                case R.id.btn_login:
                    ...
                    if (binding.etEmail.getText().toString().isEmpty()){
                        ...
                        vm.error.setValue("Enter Email");
                        return;

                    } if (!binding.etEmail.getText().toString().matches(emailPattern)){

                    vm.error.setValue("Enter valid Email");
                    return;

                }else if (binding.etPassword.getText().toString().isEmpty()){

                        vm.error.setValue("Enter Password");
                    return;
                       ...
                       /* if (binding.cbRememberMe.isChecked()){
                            sharedPref.put(Constants.EMAIL,binding.etEmail.getText().toString());
                            sharedPref.put(Constants.PASSWORD,binding.etPassword.getText().toString());
                            sharedPref.put("isRemeber",true);
                        }*/
                        vm.signIn(map);
                    }
