...
public class AddEducationActivity extends AppActivity<ActivityAddEducationBinding,AddEducationActivityVM> {
    ...
    protected void subscribeToEvents(AddEducationActivityVM vm) {
        binding.header.tvTitle.setText("Education");
                ...
                switch (view.getId()){
                    ...
                    case R.id.cv_save:
                        ...
                        if (schoolStr.isEmpty()){
                            vm.error.setValue("Please enter your school name");
                            return;
                        }
                        if (degreeStr.isEmpty()){
                            vm.error.setValue("Please enter your degree name");
                            return;
                        }

                        if (startDateStr.equals("")){
                            vm.error.setValue("Please select your degree start date");
                            return;
                        }

                        if (endDateStr.equals("")){
                            vm.error.setValue("Please select your degree end date");
                            return;
                        }
