...
public class ChatAdapter extends RecyclerView.Adapter{
    ...
    public ChatAdapter(Context context, List<MessageModel>list,int login_id){
    ...
    public void sendNewMessage(MessageModel model){
        list.add(model);
        notifyDataSetChanged();
    }

    public void updateList(List<MessageModel> model){
        list.addAll(model);
        notifyDataSetChanged();
    }
