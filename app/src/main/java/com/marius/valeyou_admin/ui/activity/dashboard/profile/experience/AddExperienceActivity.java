...
public class AddExperienceActivity extends AppActivity<ActivityAddExperienceBinding,AddExperienceActivityVM> {
    ...
    protected void subscribeToEvents(AddExperienceActivityVM vm) {
        binding.header.tvTitle.setText("Experience");
            ...
            public void onChanged(View view) {
                switch (view.getId()){
                    ...
                    case R.id.cv_save:
                        ...
                        if (title.isEmpty()){
                            vm.error.setValue("Please enter your role");
                            return;
                        }
                        if (emp_type.isEmpty()){
                            vm.error.setValue("Please select Employment Type");
                            return;
                        }

                        if (comp_name.isEmpty()){
                            vm.error.setValue("Please Enter your company name");
                            return;
                        }

                        if (location.isEmpty()){
                            vm.error.setValue("Please enter your company's location");
                            return;
                        }

                        if (startDate.isEmpty()){
                            vm.error.setValue("Please enter start date");
                            return;
                        }
                        ...
                        if (binding.cbStatus.isChecked()){
                         ...
                         map.put("endDate",endDate);
                            ...
                            if (endDate.isEmpty()){
                                vm.error.setValue("Please enter end date");
                                return;
                            }
                            map.put("endDate",endDate);
                        }
