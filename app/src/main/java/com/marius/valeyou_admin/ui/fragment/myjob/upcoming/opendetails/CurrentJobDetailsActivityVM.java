...
public class CurrentJobDetailsActivityVM extends BaseActivityViewModel{
    ...
    final SingleRequestEvent<ApiResponse<SimpleApiResponse>> startJobApiBean = new SingleRequestEvent<>();
    ...
    public void startJob(String auth_key,int job_id,int status,String start) {
        welcomeRepo.startJob(auth_key,job_id,status,start).subscribeOn(Schedulers.io())
