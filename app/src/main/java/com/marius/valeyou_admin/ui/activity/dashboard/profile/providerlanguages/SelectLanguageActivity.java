...
public class SelectLanguageActivity extends AppActivity<ActivitySelectLanguageBinding, SelectLanguageActivityVM> {
    ...
    protected void subscribeToEvents(SelectLanguageActivityVM vm) {
        ...
        if (comeFrom.equalsIgnoreCase("edit")){
            ...
            binding.titleTxt.setText("Edit Language");
            ...
            binding.titleTxt.setText("Add Language");
            ...
            public void onChanged(View view) {
                switch (view != null ? view.getId() : 0) {
                    ...
                    case R.id.cv_save:
                        ...
                        if (name.equalsIgnoreCase("search for language")){
                            vm.info.setValue("Please select Language");
                        }else if (type.equalsIgnoreCase("Select")){
                            vm.info.setValue("Please select type");
                        }else {
