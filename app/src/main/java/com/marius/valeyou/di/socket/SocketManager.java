...
public class SocketManager {
    ...
    public static String SEND_MESSAGE_LISTNER = "body";
    ...
    public SocketManager(Activity mActviity, Observer observer){
    ...
    private Emitter.Listener onNewMessage = new Emitter.Listener() {
        ...
        public void call(Object... args) {
            try {
                ...
                observer.sendMessageResponse(SEND_MESSAGE_LISTNER, data);
    ...
    public void unRegister(Observer observers){
        if (observerList!=null){
            for (int i = 0; i<observerList.size();i++){
                Object model = observerList.get(i);
