...
public class AddIdentityActivity extends AppActivity<ActivityAddIdentityBinding,AddIdentityActivityVM> {
    ...
    protected void subscribeToEvents(AddIdentityActivityVM vm) {
        binding.header.tvTitle.setText("Add Identity");
        ...
        binding.spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (selection.equalsIgnoreCase("CPF")){
                    ...
                    binding.firstImage.setText("ID");
                    binding.secondImage.setText("SELFIE");
                }
            }
            ...
            public void onRequestReceived(@NonNull Resource<SimpleApiResponse> resource) {
                switch (resource.status) {
                    ...
                    case SUCCESS:
                        ...
                        Intent intent = ProfileActivity.newIntent(AddIdentityActivity.this);
            ...
            public void onChanged(View view) {
                switch (view.getId()){
                    ...
                    case R.id.cv_save:
                        ...
                        if (frontfile == null) {
                            vm.info.setValue("Please choose image");
                            ...
                            if (comeFrom.equalsIgnoreCase("add")) {
                                ...
                                vm.addIdentity(vm.sharedPref.getUserData().getAuthKey(),type,api_type, frontbody, backbody);
                                ...
                                vm.editIdentity(vm.sharedPref.getUserData().getAuthKey(),identity_id,type,api_type,frontbody, backbody);
