...
import com.marius.valeyou.databinding.HolderSubcategoryListBinding;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ProductTitleHolder> {
    ...
    public interface ProductCallback {
        void onItemClick(View v, CategoryListBean m);
    }
    ...
    public void onBindViewHolder(@NonNull ProductTitleHolder holder, int position) {
        ...
        holder.adapter.setList(moreBean.getSubCategories());
    }
    ...
    public class ProductTitleHolder extends RecyclerView.ViewHolder {
        ...
        private SimpleRecyclerViewAdapter<SubCategoryBean, HolderSubcategoryListBinding> adapter;
